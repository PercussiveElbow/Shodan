module Shodan
    struct HostDataDocker include JSON::Serializable
        ...
        struct HostDataDockerComponent include JSON::Serializable
            @[JSON::Field(key: "Name")]
            ...
            struct HostDataDockerComponentDetails include JSON::Serializable
                @[JSON::Field(key: "ApiVersion")]
                property apiversion : String? 
        ...
        struct HostDataDockerContainer include JSON::Serializable
            ...
            struct HostDataDockerContainerConfig include JSON::Serializable
                @[JSON::Field(key: "NetworkMode")]
                property networkmode : String?
            end

            struct HostDataDockerContainerPorts include JSON::Serializable
                @[JSON::Field(key: "IP")]
                property ip : String?
            ...
            struct HostDataDockerContainerMounts include JSON::Serializable
                @[JSON::Field(key: "RW")]
                property rw : Bool? 
            ...
            struct HostDataDockerContainerNetworkSettings include JSON::Serializable
                @[JSON::Field(key: "Networks")]
                property network : Hash(String, HostDataDockerContainerNetwork)?

                struct HostDataDockerContainerNetwork include JSON::Serializable
        ...
        struct HostDataDockerPlatform include JSON::Serializable
            @[JSON::Field(key: "Name")]
            property name : String? 
        end
    end

module Shodan
    struct HostDataElastic include JSON::Serializable
    ...
    struct HostDataElasticCluster include JSON::Serializable
    ...
    struct HostDataElasticNodesMore include JSON::Serializable
    ...
    struct HostDataElasticFailure include JSON::Serializable
    ...
    struct HostDataElasticFailureCausedBy include JSON::Serializable
    ...
    # Node
    struct HostDataElasticNode include JSON::Serializable
        property cluster_name : String? 
    ...
    struct HostDataElasticNodeStat include JSON::Serializable
        property failed : Int64? 
    ...
    struct HostDataElasticAttributes include JSON::Serializable
    ...
    struct HostDataElasticNodeCPUData include JSON::Serializable
    ...
    struct HostDataElasticIngest include JSON::Serializable
    ...
    struct HostDataElasticModule include JSON::Serializable
    ...
    struct HostDataElasticNetwork include JSON::Serializable 
        property primary_interface : HostDataElasticPrimaryInterface? 
        property refresh_interval_in_millis : Int64? 
    end

    struct HostDataElasticNodeInfo include JSON::Serializable 
    ...
    struct HostDataElasticOsInfo include JSON::Serializable
    ...
    struct HostDataElasticPlugin include JSON::Serializable
        property classname : String? 
        property description : String? 
        property elasticsearch_version : String? 
        property extended_plugins : Array(String)? 
    ...
    struct HostDataElasticPrimaryInterface include JSON::Serializable
        property address : String
        property mac_address : String
        property name : String
    end

    struct HostDataElasticProcessor include JSON::Serializable
        property json : String 
    end

    struct HostDataElasticSwap include JSON::Serializable
        property total_in_bytes : Int64
    end

    struct HostDataElasticTransport include JSON::Serializable
        property bound_address : Hash(String,String)
    ...
    # Commons 
    struct HostDataElasticJVMMemory include JSON::Serializable
    ...
    struct HostDataElasticOsMemory include JSON::Serializable
    ...
    struct HostDataElasticProcess include JSON::Serializable
        property id : Int64?
    ...
    # Index 
    struct HostDataElasticIndex include JSON::Serializable
        property primaries : HostDataElasticIndexStats
        property total : HostDataElasticIndexStats 
        property uuid : String?
    end

    struct HostDataElasticIndexStats include JSON::Serializable
        property indexing : HostDataElasticIndexing?
    end

    struct HostDataElasticIndexing include JSON::Serializable
    ...
    struct HostDataElasticCompletion include JSON::Serializable
        property size_in_bytes : Int64
    end

    struct HostDataElasticNodeCount include JSON::Serializable
    ...
    struct HostDataElasticCPULoad include JSON::Serializable
        property percent : Int64
    end

    struct HostDataElasticCPUItem include JSON::Serializable
        property cache_size_in_bytes : Int64
        property cores_per_socket : Int64
    ...
    struct HostDataElasticIndexDocs include JSON::Serializable
        property count : Int64
        property deleted : Int64
    end

    struct HostDataElasticIndexFieldData include JSON::Serializable
        property evictions : Int64 
        property memory_size_in_bytes : Int64 
    end

    struct HostDataElasticFilterCache include JSON::Serializable
        property evictions : Int64 
        property memory_size_in_bytes : Int64 
    end

    struct HostDataElasticFS include JSON::Serializable
    ...
    struct HostDataElasticIdCache include JSON::Serializable
        property memory_size_in_bytes : Int64
    end

    struct HostDataElasticShardIndex include JSON::Serializable
    ...
    struct HostDataElasticIndexMetric include JSON::Serializable
        property avg : Float64
        property max : Float64
        property min : Float64
    end

    struct HostDataElasticIndices include JSON::Serializable
    ...
    struct HostDataElasticIndicesShards include JSON::Serializable
    ...
    struct HostDataElasticJVMData include JSON::Serializable
    ...
    struct HostDataElasticJVMVersion include JSON::Serializable
        property count : Int64 
        property vm_name : String 
        property vm_vendor : String
        property vm_version : String 
    ...
    struct HostDataElasticOSName include JSON::Serializable
        property count : Int64
        property name : String? 
    end

    struct HostDataElasticNetworkTypes include JSON::Serializable
        property http_types : Hash(String,Int64)
        property transport_types : Hash(String,Int64)
    end

    struct HostDataElasticNodes include JSON::Serializable
    ...
    struct HostDataElasticOpenFileDescriptiors include JSON::Serializable
        property avg : Int64 
        property max : Int64 
        property min : Int64
    end

    struct HostDataElasticOS include JSON::Serializable
        property allocated_processors : Int64? 
        property available_processors : Int64?
    ...
    struct HostDataElasticPercolate include JSON::Serializable
    ...
    struct HostDataElasticPrettyName include JSON::Serializable
        property count : Int64 
        property pretty_name : String
    end

    struct HostDataElasticQueryCache include JSON::Serializable
    ...
    struct HostDataElasticSegments include JSON::Serializable
        property count : Int64
    ...
    struct HostDataElasticStore include JSON::Serializable
        property size_in_bytes : Int64
        property throttle_time_in_millis : Int64
    end

    struct HostDataElasticPackagingType include JSON::Serializable
        property count : Int64

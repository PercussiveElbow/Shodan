module Shodan
  struct HostDataMinecraft
    ...
    struct HostDataMinecraftServerVersion
      include JSON::Serializable
      property protocol : Int64?
      property name : String?
    end

    struct HostDataMinecraftPlayersInfo
      include JSON::Serializable
      property max : Int64?
      property name : String?
    end

    struct HostDataMinecraftForgeInfo
      include JSON::Serializable
    ...
    struct HostDataMinecraftForgeChannels
      include JSON::Serializable
      property res : String?
    ...
    struct HostDataMinecraftMod
      include JSON::Serializable
      property modmarker : String?
      property modId : String?
    end

    struct HostDataMinecraftModInfoItem
      include JSON::Serializable
      property version : String?
      property modId : String?
    end

    struct HostDataMinecraftPlayers
      include JSON::Serializable
      property id : String?
      property name : String?
    end

    struct HostDataMinecraftModInfo
      include JSON::Serializable

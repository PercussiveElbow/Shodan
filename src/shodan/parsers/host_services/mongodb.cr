module Shodan
    struct HostDataMongoDB include JSON::Serializable
    ...
    struct HostDataMongoDBServerStatus include JSON::Serializable
        # property metrics : HostDataMongoDBMetrics

    end

    struct HostDataMongoBuildInfo include JSON::Serializable
    ...
    struct HostDataMongoBuildEnvironment include JSON::Serializable
        property bits : Int64? 
        property cc : String? 
    ...
    struct HostDataMongoListDatabases include JSON::Serializable
    ...
    struct HostDataMongoDatabase include JSON::Serializable 
    ...
    struct HostDataMongoOpenSSL include JSON::Serializable

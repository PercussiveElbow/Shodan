module Shodan
    struct HostDataRedis include JSON::Serializable
    ...
    struct HostDataRedisReplication include JSON::Serializable
    ...
    struct HostDataRedisPersistence include JSON::Serializable
    ...
    struct HostDataRedisMemory include JSON::Serializable
    ...
    struct HostDataRedisKeys include JSON::Serializable
        property data : Array(String)
        property more : Bool
    end

    struct HostDataRedisServer include JSON::Serializable
    ...
    struct HostDataRedisCPUData include JSON::Serializable
    ...
    struct HostDataRedisSSL include JSON::Serializable
    ...
    struct HostDataRedisOOMPrevention include JSON::Serializable
